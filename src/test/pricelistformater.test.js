...
const sort = require('../pricelistformater');
var expect = chai.expect;
var should = chai.should;
const priceListFormater = require("../pricelistformater");
...
describe('Price list test', function() {
    it('priceListFormatter should be a function', function () {
        priceListFormater(pricelist);
    });
    it('result shuld be in this format:(price : date_from : date_to)', function() {
    ...
    it('Rezult to expected format (price : date_from : date_to) and puts each record into newline', function() {
